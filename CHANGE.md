...
#### Additions 🎉
- ModelPrimitive等类增加clampToTileset等参数

#### Fixes 🔧  
- 修复v3.2.3产生的symbol配置的样式失效
- 修复label的show:false时默认显示
...
- map增加toolbar和controls中增加ceisum原生控件的获取，方便使用。
- map增加load事件

#### Fixes 🔧  
- 测试并修改V3.2.0产生的多个bug问题
...
- 瓦片图层增加invertColor、filterColor 滤镜颜色参数，支持修改瓦片颜色
- 重写DivGraphic的编辑处理，支持直接拖拽div对象
...
- widget的disableOther配置支持数组，释放指定的多个widget
...
## 3.1.17  - 2021-12-19 
#### Additions 🎉
- DivLayer内方法均融合至GraphicLayer，可以DivLayer批量替换为GraphicLayer(v3.2将移除DivLayer)
...
- RectSensor和ConicSensor增加hideRayEllipsoid属性
