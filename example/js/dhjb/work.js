...
function initEditorJS() {
  ...
  var sddPoint = {
    activate: function () {
      ...
      this.point = JB.addPoint(arrPoint, "red"); //添加点
  ...
  var abdPoint = {
    activate: function () {
      ...
      this.lable = JB.addLabel(arrPoint, "yellow"); //添加注记
      this.point = JB.addPoint(arrPoint, "yellow"); //添加点

      JB.showPanel('<span class="myp">鞍部点</span>');
    },
    disable: function () {
      JB.changeGraphicShow(this.lable, false);
    },
  ...
  var qxbhdPoint = {
    activate: function () {
      ...
      this.lable = JB.addLabel(arrPoint); //添加注记
      this.point = JB.addPoint(arrPoint, "white"); //添加点

      JB.showPanel('<span class="myp">倾斜变换点</span>');
    },
    disable: function () {
      JB.changeGraphicShow(this.lable, false);
    },
  ...
  var fxbhdPoint = {
    activate: function () {
      ...
      this.lable = JB.addLabel(arrPoint); //添加注记
      this.point = JB.addPoint(arrPoint, "blue"); //添加点

      JB.showPanel('<span class="myp">方向变换点</span>');
    },
    disable: function () {
      JB.changeGraphicShow(this.lable, false);
    },
  ...
  var showLine1 = {
    activate: function () {
      ...
      // 将geojson格式数据转换为graphic后加载到图层只中
      map.graphicLayer.loadGeoJSON(geojson);

      JB.showPanel('<span class="myp">山脊线</span>');
    },
    disable: function () {
      // 移除线
      // if (this.line) {
  ...
  var showLine2 = {
    activate: function () {
      ...
      JB.showPanel('<span class="myp">山谷线</span>');
    },
    disable: function () {
      // 移除线
      // if (this.line) {
  ...
  var showLine3 = {
    activate: function () {
      ...
      JB.showPanel('<span class="myp">变换线</span>');
    },
    disable: function () {
      // 移除线
      // if (this.line) {
  ...
  var dgxWork = {
    activate: function () {
      ...
      JB.showPanel('<span class="myp">等高线</span>');
    },
    disable: function () {
      if (this.contourLine) {
