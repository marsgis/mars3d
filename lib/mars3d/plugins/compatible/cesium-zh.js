(function () {
  ...
  function loadBaseLayerPickerOfToolbar() {
    ...
    if (dropDownContainer.length > 0) {
      ...
      var selectLayerToolbar = document.getElementsByClassName(
  ...
  function loadToolBarHelp() {
    ...
    //鼠标
    var mouseButton = document.getElementsByClassName(
    ...
    var touchButton = document.getElementsByClassName(
  ...
  function loadFlyController() {
    ...
    //修改底部描述
    var cesiumDescription = document.getElementsByClassName(
      "cesium-credit-textContainer"
    );
    if (cesiumDescription.length > 0) {
      var insertEvent = function (e) {
        e = e || event;
        cesiumDescription[0].removeEventListener(
          "DOMNodeInserted",
          insertEvent
        );
