...
; (function () {
  ...
  function load() {
    ...
    var libsConfig = {
      'vue': [
        libpath + "vue/vue.global.js",
        libpath + "vue/element/index.css",
        libpath + "vue/element/index.full.js"
      ],
      'jquery': [
      ...
      'cesium-tdt': [//天地图三维
        libpath_local + "mars3d/plugins/tdt/mars3d-tdt.js",
      ],
      'cesium-pbf': [
        libpath_local + "mars3d/thirdParty/pbf/ol.js",
        libpath_local + "mars3d/thirdParty/pbf/mvt.js",
        libpath_local + "mars3d/thirdParty/pbf/style/MapboxStreetsV6.js",
      ],
      'mars3d-space': [
        //卫星插件
       libpath_local + 'mars3d/plugins/space/mars3d-space.js',
      ],
      'mars3d-echarts': [
        //echarts支持插件
        libpath + "echarts/echarts.min.js",
        libpath + "echarts/echarts-gl/echarts-gl.min.js",
       libpath_local + 'mars3d/plugins/echarts/mars3d-echarts.js',
      ],
      'mars3d-mapv': [
        //mapv支持插件
        libpath + 'mapV/mapv.min.js',
       libpath_local + 'mars3d/plugins/mapv/mars3d-mapv.js',
      ],
      'mars3d-heatmap': [
        //heatmap热力图支持插件
       libpath_local + 'mars3d/plugins/heatmap/heatmap.min.js',
       libpath_local + 'mars3d/plugins/heatmap/mars3d-heatmap.js',
      ],
      "mars3d-wind": [//风场图层插件
        libpath_local + "mars3d/plugins/wind/netcdfjs.js", //m10_windLayer解析nc
        libpath_local + "mars3d/plugins/wind/mars3d-wind.js"
      ],
      'mars3d-widget': [
        //项目widget模块插件
       libpath_local + 'mars3d/plugins/widget/mars3d-widget.css',
       libpath_local + 'mars3d/plugins/widget/mars3d-widget.js',
      ],
      ...
      'mars3d': [
        ...
        //libpath_local + 'mars3d/plugins/compatible/cesium-version.js', //cesium版本兼容处理
        libpath_local + 'mars3d/mars3d.css', //mars3d
        libpath_local + 'mars3d/mars3d.js', 
      ],
